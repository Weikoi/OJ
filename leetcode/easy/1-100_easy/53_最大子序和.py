...
class Solution:
    ...
    def maxSubArray(self, nums):
        ...
        for idx in range(list_length):
            each_list = []
            max_value = nums[idx]
            each_list.append(max_value)
            for j in nums[idx + 1:]:
                max_value = max_value + j
                each_list.append(max_value)
